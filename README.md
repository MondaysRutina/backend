...
### 6-3. 메인 화면
1. 캘린더의 날짜를 누르면 피부 일기를 다시 볼 수 있다.</br>
로그인한 사용자의 닉네임이 보인다.</br>
  <img src="image/실행화면/메인화면.png" width="50%"></img></br>

2. 슬라이더 메뉴를 통해 월간 보고서를 확인할 수 있다.
...
- 메인 화면의 일기 작성 버튼을 누르면 데일리 다이어리를 작성할 수 있다.</br>
  ...
  |             사진 촬영 및 사용한 화장품 선택              |                   피부 상태 기록 및 메모                   |
  |:-------------------------------------------:|:-------------------------------------------------:|
  | <img src="image/실행화면/데일리다이어리작성1.png"></img> | <img src="image/실행화면/데일리다이어리작성2.png"></img> |

### 6-5. 나의 화장대
- 사용하는 화장품을 등록 : 화장품 데이터를 불러와 사용자가 추가/삭제할 수 있는 화장품 목록을 보여준다.
- 스킨 케어 루틴 등록 : 스킨 케어 루틴 등록하여 데일리 다이어리 작성 시 사용한 루틴을 불러올 수 있다.
